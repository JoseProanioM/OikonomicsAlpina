...
@st.cache_data
def load_data():
    df = pd.read_excel(r"C:\Users\josep\OneDrive\Desktop\precios.xlsx")
...
<div class="header-bar">
  <h1>🏷️ Referencia de Precios Percha</h1>
  <p>Herramienta de consulta rápida para encuestadores · Precios SMX con escenarios de aumento de precios</p>
</div>
""", unsafe_allow_html=True)
